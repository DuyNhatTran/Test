...
public class ManagerStaffClient extends Staff{
    
    // constructor
    public ManagerStaffClient(){
        super();
        this.updateIdStaff();
    }
    
    public ManagerStaffClient(String ID_Staff, String fullName, String password, String ID_Person, String phoneNumber,
    ...
    private void updateIdStaff() {
        String idManagerRoom = "MSC" + this.getID_Staff();
