...
public class TicketInspector extends Staff {
    ...
    // constructor
    public TicketInspector() {
        super();
        this.updateIdStaff();
    }

    public TicketInspector(String ID_Staff, String fullName, String password, String ID_Person, String phoneNumber,
...
// hàm xử lý sự kiện
    private void updateIdStaff() {
        String idTicketInspector = "STI" + this.getID_Staff();
        this.setID_Staff(idTicketInspector);
    }
