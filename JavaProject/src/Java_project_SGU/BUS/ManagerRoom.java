...
public class ManagerRoom extends Staff{
    ...
    public ManagerRoom(String ID_Staff, String fullName, String password, String ID_Person, String phoneNumber,
            ...
            InvalidNameException, InvalidEmailException, InvalidPhoneException, InvalidBirthdayException, ParseException, InvalidIdPersonException, InvalidPasswordCusException, InvalidMoneyException, InvalidAccountCusException {
    ...
    private void updateIdStaff() {
        String idManagerRoom = "MRO" + this.getID_Staff();
