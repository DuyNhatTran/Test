 ...
 * @author ADMIN
 */
public class AddShowtimeDialog extends javax.swing.JDialog implements ActionListener{
     ...
     */
    public AddShowtimeDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public AddShowtimeDialog(java.awt.Frame parent, boolean modal, 
            ManageEmployeeFrm manageEmployeeFrm) {
        this(parent, modal);
    ...
    private void initComponents() {
        ...
        roomMovieCB = new javax.swing.JComboBox<>();
        ...
        addShowtimeBtn.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        roomMovieCB.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        roomMovieCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ROOM1", "ROOM2", "ROOM3", "ROOM4", "ROOM5" }));
        roomMovieCB.setSelectedIndex(-1);
        roomMovieCB.setToolTipText("");
        roomMovieCB.setBorder(null);
        roomMovieCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                roomMovieCBActionPerformed(evt);
            }
        });

        jButton3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Java_project_SGU/Image/refresh-icon.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(roomMovieCB, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(50, 50, 50)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(addShowtimeBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(143, 143, 143))))
        );
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addGap(5, 5, 5)
                                .addComponent(roomMovieCB, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20)
                                .addComponent(jLabel13)
                                .addGap(5, 5, 5)
    ...
    private void roomMovieCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roomMovieCBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_roomMovieCBActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddShowtimeDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddShowtimeDialog dialog = new AddShowtimeDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox<String> roomMovieCB;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src.equals(this.nameMovieCB)) {
            updateMovieLB();
        } else if (src.equals(this.roomMovieCB)) {
            updateRoomLB();
        } else if (src.equals(this.addShowtimeBtn)) {
            addNewShowTime();
        }
    }
    
    private void addActionListner() {
        FocusListenerAddShowtimeDialog focusListener = 
                new  FocusListenerAddShowtimeDialog(this);
        this.nameMovieCB.addActionListener(this);
        this.roomMovieCB.addActionListener(this);
   ...
   public void updateRoomLB () {
        String room = roomMovieCB.getSelectedItem().toString();
    ...
    private void addNewShowTime() {
        String roomId = "";
        if (this.roomMovieCB.getSelectedIndex() > -1) {
            roomId = this.roomMovieCB.getSelectedItem().toString();
        }
        ...
        if (roomId.isEmpty() || fomartMovie.isEmpty() || movieShowTime == null
                ...
                this.roomMovieCB.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(rootPane, "VUI LÒNG "
                    + "ĐIỀN ĐẦY ĐỦ THÔNG TIN!");
        } else {
            ShowTime showTime = new ShowTime(null, startTime, movieShowTime, 
                    roomShowTime, fomartMovie, priceTicket, false);
            System.out.println(showTime.getIdShowTime());
            this.manageEmployeeFrm.addShowtimeCallBack(showTime);
